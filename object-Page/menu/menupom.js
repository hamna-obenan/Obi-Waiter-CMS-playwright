 ...
 * Handles menu creation, form filling, and image uploads
 */
export default class MenuPOM {
  constructor(page) {
    this.page = page;
  }

  /**
   * Navigate to Create Menu page with correct flow: Select Venue → Add Menu → Create → Company → Fill Form
   */
  async navigateToCreateMenu() {
    ...
    console.log('✅ Navigated to Create Menu page with correct flow');
  }
